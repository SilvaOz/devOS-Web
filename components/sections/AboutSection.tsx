        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              ...
              <p className="text-sm font-mono mb-4" style={{ color: 'var(--muted-light)' }}>
                {ABOUT.role}
              </p>
              <p className="text-base leading-relaxed mb-3" style={{ color: 'var(--muted-light)' }}>
                {ABOUT.paragraph}
              </p>
              <p className="text-base leading-relaxed" style={{ color: 'var(--muted-light)' }}>
                {ABOUT.paragraph2}
              </p>
            </div>
